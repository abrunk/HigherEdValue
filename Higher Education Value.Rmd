...
Now lets see which schools get the biggest differences between predicted and actual salaries
...
The final result makes sense - attending MIT causes the most significant value add of any college - but I'm surprised that the model estimates its only worth about $5k in annual income 10 years post-graduation.