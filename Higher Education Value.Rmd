...
With these additional variables included, the predictive power of our model goes from .58 to .84. However, it's likely we have included too many features, so we'll try a backwards stepwise regression to focus on the most important ones.
